#include <plastic_bottle_detector_inferencing.h>
#include "edge-impulse-sdk/dsp/image/image.hpp"
#include "esp_camera.h"

bool Check_SignalFromArduino;
bool isThereObject = true;
float AccuracyRate;
byte countAccur = 0;
...
*/
void loop() {
  Check_SignalFromArduino = digitalRead(12);
  ...
  if (Check_SignalFromArduino && isThereObject) {
